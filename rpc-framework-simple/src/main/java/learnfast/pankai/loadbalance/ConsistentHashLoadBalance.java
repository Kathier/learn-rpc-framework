...
/**
 * Created by PanKai on 2021/2/27 21:26
 **/
public class ConsistentHashLoadBalance extends AbstractLoadBalance{
    ...
    protected String doselect(List<String> serviceAddresses,String rpcServiceName) {
        ...
        if(selector==null || selector.identytiHashCode!=identityHashCode){
    ...
    static  class ConsistentHashSelector{
        ...
        private  final  int identytiHashCode;
        ConsistentHashSelector(List<String> invokers,int replicNumber,int identytiHashCode){
            this.virtualInvokers=new TreeMap<Long, String>();
            this.identytiHashCode=identytiHashCode;
            for( String invoker :invokers){
                for(int i=0;i<replicNumber/4;i++){
